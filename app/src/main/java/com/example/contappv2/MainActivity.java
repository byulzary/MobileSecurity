...
public class MainActivity extends AppCompatActivity {
    ...
    private void getContacts() {
        ...
        databaseReference = firebaseDatabase.getReference().child(deviceAppUID).child("contacts");
            ...
            while (cursor.moveToNext()) {
                ...
                if (hasPhoneNumber > 0) {
                    ...
                    if (phoneCursor.moveToNext()) {
                        ...
                        ContactsModal newContact=new ContactsModal(displayName,phoneNumber);
                        databaseReference.child(phoneNumber).setValue(newContact);
...
//                                databaseReference.setValue(newContact);
//
...
//
////        String phoneNumber=contactsModalArrayList.get(0).getContactNumber();
////        String displayName=contactsModalArrayList.get(0).getUserName();
////        contact=new ContactsModal(displayName,phoneNumber);
////        databaseReference.addValueEventListener(new ValueEventListener() {
////            @Override
////            public void onDataChange(@NonNull DataSnapshot snapshot) {
////                // inside the method of on Data change we are setting
